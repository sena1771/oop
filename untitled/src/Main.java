                            ...
                            case 3:
                                ...
                                for (int l = 0; l < shipmentArrayList.size(); l++) {
                                    ...
                                    if (shipmentArrayList.get(l).getId() == (idm)) {
                                     ...
                                     System.out.println("Update the cargo status Shipment "+idm+"to the: ");
                                     branch=sca.next();
                                        shipmentArrayList.get(l).setCurrent_place(branch);

                                        for (int i=0;i<branchArrayList.size();i++) {
                                  if(branch!=branchArrayList.get(i).getBranch_name()){
        System.out.println("This branch does not exist in the system");
    }
}
